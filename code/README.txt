...
There are multiple header and .cpp files, your implementation will go into the following files:
	•	parallel_sort.h: Declares the API for the parallel sorting implementation. Declare your own helper functions in this file.
...
Other files containing code that you should not change are:
	•	main.cpp: Implements code for the main executable sort. This does input/output reading and calling of the actual functions.
	•	utils.h/utils.cpp: common utility functions
	•	io.h/io.cpp: implements IO functions and random input generation, and MPI gather/scatter functions
...
Utility scripts (you may play around with these to generate your own custom input):
	•	input.py: Python script to generate random inputs. Feel free to modify this script in order to generate different types of input.
...
After compilation, you'll have an executable sort. You can use this program as follows:
